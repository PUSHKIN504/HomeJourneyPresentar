...
namespace SIGESPROC.IntegrationTest
{
    [TestClass]
    public class GestionAdicionalIntegrationTest : DbContextMocker
    {
        ...
        public async Task GestionAdicionalCrearTest()
        {
            ...
            var gestionAdicionalMock = GestionAdicionalMocks.CrearMockGestionesAdicionales();


            // Serializa el objeto a JSON para enviarlo en el cuerpo de la peticion
            var contenido = new StringContent(System.Text.Json.JsonSerializer.Serialize(gestionAdicionalMock), System.Text.Encoding.UTF8, "application/json");
        ...
        public async Task GestionAdicionalEditarTest()
        {
            ...
            var gestionAdicionalMock = GestionAdicionalMocks.EditarMockGestionesAdicionales();
