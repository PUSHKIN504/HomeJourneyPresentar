...
{   [TestClass]
    public class ActividadesPorEtapaIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task ActividadesPorEtapaCrearTest()
        {
            ...
            var ActividadPorEtapaMock = ActividadesPorEtapaMocks.CrearMockActividadesPorEtapa();


            // Serializa el objeto a JSON para enviarlo en el cuerpo de la peticion
            var contenido = new StringContent(System.Text.Json.JsonSerializer.Serialize(ActividadPorEtapaMock), System.Text.Encoding.UTF8, "application/json");
        ...
        [TestMethod]
        public async Task ActividadesPorEtapaEditarTest()
        {
            ...
            var ActividadesPorEtapaMock = ActividadesPorEtapaMocks.EditarMockActividadesPorEtapa();


            // Serializa el objeto a JSON para enviarlo en el cuerpo de la peticion
            var contenido = new StringContent(System.Text.Json.JsonSerializer.Serialize(ActividadesPorEtapaMock), System.Text.Encoding.UTF8, "application/json");
