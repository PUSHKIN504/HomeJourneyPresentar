...
{
    [TestClass]
    public class CategoriaViaticoIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task CategoriaViaticoInsertar()
        {
            ...
            var Mock = CategoriaViaticoMocks.CrearMockCategoriaViatico();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/CategoriaViatico/Insertar", contenido);
        ...
        [TestMethod]
        public async Task CategoriaViaticoActualizar()
        {
            ...
            var Mock = CategoriaViaticoMocks.ActualizarMockCategoriaViatico();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/CategoriaViatico/Actualizar", contenido);
            response.EnsureSuccessStatusCode();
