...
{
    [TestClass]
    public class EmpresaBienRaizIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task EmpresaBienRaizInsertar()
        {
            // Creamos el cliente
            ...
            var cotizacionMock = EmpresaBienRaizMocks.CrearEmpresaBienRaiz();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/EmpresaBienesRaices/Insertar", contenido);
        ...
        [TestMethod]
        public async Task EmpresaBienRaizEditar()
        {
            var cliente = factory.CreateClient();
            cliente.DefaultRequestHeaders.Add("XApiKey", ApiKey);

            var cotizacionDetalleMock = EmpresaBienRaizMocks.EditarEmpresaBienRaiz();
            ...
            var response = await cliente.PutAsync("https://localhost:44337/api/EmpresaBienesRaices/Actualizar", contenido);
