...
{
    [TestClass]
    public class DeduccionIntegrationTest : DbContextMocker
    {
        ...
        public async Task CostoPorActividadInsertar()
        {
            ...
            var Mock = DeduccionMocks.CrearMockDeduccion();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Deduccion/Insertar", contenido);
        ...
        public async Task CostoPorActividadActualizar()
        {
            ...
            var Mock = DeduccionMocks.ActualizarMockDeduccion();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Deduccion/Actualizar", contenido);
            response.EnsureSuccessStatusCode();
