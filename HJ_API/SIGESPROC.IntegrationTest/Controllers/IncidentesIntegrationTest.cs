...

{
    ...
    public class IncidentesIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task IncidentesCrearTest()
        {
            ...
            var incidenteMock = IncidentesMocks.CrearMockIncidentes();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Incidente/Insertar", contenido);
        ...
        public async Task IncidentesEditarTest()
        {
            ...
            var incidenteMock = IncidentesMocks.EditarMockIncidentes();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Incidente/Actualizar", contenido);
            //response.EnsureSuccessStatusCode();
