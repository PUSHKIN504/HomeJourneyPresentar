...
{
    [TestClass]
    public class ProveedorIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task ProveedorInsertar()
        {
            ...
            var bienRaizMock = ProveedorMock.CrearMoskProveedor();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Proveedor/Insertar", contenido);
        ...
        [TestMethod]
        public async Task Proveedoractualizar()
        {
            ...
            var bienRaizMock = ProveedorMock.EditarMoskProveedor();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Proveedor/Actualizar", contenido);
            //response.EnsureSuccessStatusCode();
