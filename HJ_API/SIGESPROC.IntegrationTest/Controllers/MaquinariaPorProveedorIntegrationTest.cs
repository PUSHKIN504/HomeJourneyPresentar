...
{
    [TestClass]
    public class MaquinariaPorProveedorIntegrationTest : DbContextMocker
    {
        ...
        public async Task ViaticoEmcabezadoInsertar()
        {
            ...
            var bienRaizMock = MaquinariaPorProveedorMocks.CrearMoskMaquinariasPorProveedores();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/MaquinariaPorProveedor/Insertar", contenido);
        ...
        public async Task ViaticoEmcabezadoactualizar()
        {
            ...
            var bienRaizMock = MaquinariaPorProveedorMocks.EditarMoskMaquinariasPorProveedores();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/MaquinariaPorProveedor/Actualizar", contenido);
            //response.EnsureSuccessStatusCode();
