...
{
    [TestClass]
    public class MaquinariaIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task MaquinariaInsertar()
        {
            ...
            var bienRaizMock = MaquinariaMocks.CrearMoskMaquinaria();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Maquinaria/Insertar", contenido);
        ...
        [TestMethod]
        public async Task Maquinariaactualizar()
        {
            ...
            var bienRaizMock = MaquinariaMocks.EditarMoskMaquinaria();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Maquinaria/Actualizar", contenido);
            //response.EnsureSuccessStatusCode();
