...
namespace SIGESPROC.IntegrationTest.Controllers
{
    ...
    public class PrestamoIntegrationTest : DbContextMocker
    {
        ...
        public async Task CostoPorActividadInsertar()
        {
            ...
            var Mock = PrestamoMock.CrearMockPrestamos();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Prestamo/Insertar", contenido);
        ...
        public async Task CostoPorActividadActualizar()
        {
            ...
            var Mock = PrestamoMock.ActualizarMockPrestamos();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Prestamo/Actualizar", contenido);
            response.EnsureSuccessStatusCode();
