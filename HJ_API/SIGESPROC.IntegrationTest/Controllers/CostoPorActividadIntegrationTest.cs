...
{
    [TestClass]
    public class CostoPorActividadIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task CostoPorActividadInsertar()
        {
            ...
            var Mock = CostoPorActividadMocks.CrearMockCostoPorActividad();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/CostoPorActividad/Insertar", contenido);
        ...
        [TestMethod]
        public async Task CostoPorActividadActualizar()
        {
            ...
            var Mock = CostoPorActividadMocks.ActualizarMockCostoPorActividad();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/CostoPorActividad/Actualizar", contenido);
            response.EnsureSuccessStatusCode();
