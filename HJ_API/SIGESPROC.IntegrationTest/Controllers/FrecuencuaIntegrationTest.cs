...
namespace SIGESPROC.IntegrationTest.Controllers
{
    ...
    public class FrecuencuaIntegrationTest : DbContextMocker
    {
        ...
        public async Task CostoPorActividadInsertar()
        {
            ...
            var Mock = FrecuenciaMocks.CrearMockFrecuencias();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Frecuencia/Insertar", contenido);
        ...
        public async Task CostoPorActividadActualizar()
        {
            ...
            var Mock = FrecuenciaMocks.ActualizarMockFrecuencias();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Frecuencia/Actualizar", contenido);
            response.EnsureSuccessStatusCode();
