...
{
    [TestClass]
    public class DocumentoBienRaizIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task DocumentoBienRaizInsertar()
        {
            // Creamos el cliente
            ...
            var cotizacionMock = DocumentoBienRaizMocks.CrearMockDocumentoBienRaiz();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/DocumentoBienRaiz/Insertar", contenido);
        ...
        [TestMethod]
        public async Task DocumentoBienRaizEditar()
        {
            var cliente = factory.CreateClient();
            cliente.DefaultRequestHeaders.Add("XApiKey", ApiKey);

            var cotizacionDetalleMock = DocumentoBienRaizMocks.EditarMockDocumentoBienRaiz();
            ...
            var response = await cliente.PutAsync("https://localhost:44337/api/DocumentoBienRaiz/Actualizar", contenido);
