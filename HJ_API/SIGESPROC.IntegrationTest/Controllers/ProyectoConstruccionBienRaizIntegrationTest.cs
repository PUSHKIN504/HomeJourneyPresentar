...
{
    [TestClass]
    public class ProyectoConstruccionBienRaizIntegrationTest : DbContextMocker
    {

        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task ProyectoConstruccionBienRaizInsertar()
        {
            // Creamos el cliente
            ...
            var cotizacionMock = ProyectoConstruccionBienRaizMocks.CrearMockProyectooConstruccionBienRaiz();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/ProyectoContruccionBienRaiz/Insertar", contenido);
        ...
        [TestMethod]
        public async Task ProyectoConstruccionBienRaizEditar()
        {
            var cliente = factory.CreateClient();
            cliente.DefaultRequestHeaders.Add("XApiKey", ApiKey);

            var cotizacionDetalleMock = ProyectoConstruccionBienRaizMocks.EditarMockProyectoConstruccionBienRaiz();
            ...
            var response = await cliente.PutAsync("https://localhost:44337/api/ProyectoContruccionBienRaiz/Actualizar", contenido);
