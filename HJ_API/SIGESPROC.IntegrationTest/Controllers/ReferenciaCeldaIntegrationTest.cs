...
{
    [TestClass]
    public class ReferenciaCeldaIntegrationTest : DbContextMocker
    {

         private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task ReferenciaCeldaInsertar()
        {
            //creamos el cliente
            ...
            var mock = ReferenciaCeldaMock.InsertarReferenciaCeldaMock();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/ReferenciaCelda/Insertar", contenido);
