...
{
    [TestClass]
    public class NotificacionIntegrationTest : DbContextMocker
    {

         private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task NotificacionActualizar()
        {
            ...
            var mock = NotificacionMock.ActualizarNotificacionMock();
            ...
            var response = await cliente.PutAsync("https://localhost:44337/api/Notificacion/Actualizar", contenido);
        ...
        [TestMethod]
        public async Task NotificacionInsertar()
        {
            //creamos el cliente
            var cliente = factory.CreateClient();
            ...
            var mock = NotificacionMock.InsertarNotificacionMock();

            // Serializa el objeto a JSON para enviarlo en el cuerpo de la peticion
            var contenido = new StringContent(System.Text.Json.JsonSerializer.Serialize(mock), System.Text.Encoding.UTF8, "application/json");

            // Aquí hace la petición a la URL tipo Post
            var response = await cliente.PostAsync("https://localhost:44337/api/Notificacion/Insertar", contenido);
