...
{
    [TestClass]
    public class MaterialIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task MaterialInsertar()
        {
            ...
            var bienRaizMock = MaterialMock.CrearMoskMaterial();
            ...
            var response = await cliente.PostAsync("https://localhost:44337/api/Material/Insertar", contenido);
        ...
        [TestMethod]
        public async Task Materialactualizar()
        {
            ...
            var bienRaizMock = MaterialMock.EditarMoskMaterial();
            ...
            //aqui hace la peticion ala url tipo Post
            var response = await cliente.PutAsync("https://localhost:44337/api/Material/Actualizar", contenido);
            //response.EnsureSuccessStatusCode();
