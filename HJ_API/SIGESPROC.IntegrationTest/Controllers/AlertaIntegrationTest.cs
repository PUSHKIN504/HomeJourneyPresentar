...
{   [TestClass]
    public class AlertaIntegrationTest : DbContextMocker
    {
        private const string ApiKey = "4b567cb1c6b24b51ab55248f8e66e5cc";

        [TestMethod]
        public async Task AlertaCrearTest()
        {
            ...
            var AlertasMock = AlertasMocks.CrearMockAlerta();


            // Serializa el objeto a JSON para enviarlo en el cuerpo de la peticion
            var contenido = new StringContent(System.Text.Json.JsonSerializer.Serialize(AlertasMock), System.Text.Encoding.UTF8, "application/json");
        ...
        [TestMethod]
        public async Task AlertaEditarTest()
        {
            ...
            var AlertaMock = AlertasMocks.EditarMockAlerta();


            // Serializa el objeto a JSON para enviarlo en el cuerpo de la peticion
            var contenido = new StringContent(System.Text.Json.JsonSerializer.Serialize(AlertaMock), System.Text.Encoding.UTF8, "application/json");
