...
namespace SIGESPROC.UnitTest.Services
{
    ...
    public class ProyectoUniTest
    {
        ...
        public void ProyectoCreate()
        {
            ...
            MockProyectoRepository.Setup(pr => pr.Insert(It.IsAny<tbProyectos>()))
              .Returns(new RequestStatus { CodeStatus = 1, MessageStatus = "Exito" });

            var result = _proyectoService.InsertarProyecto(modelo);
        ...
        public void Update()
        {
            ...
            MockProyectoRepository.Setup(pr => pr.Update(It.IsAny<tbProyectos>()))
           .Returns(new RequestStatus { CodeStatus = 1, MessageStatus = "Exito" });

            var result = _proyectoService.ActualizarProyecto(modelo);
