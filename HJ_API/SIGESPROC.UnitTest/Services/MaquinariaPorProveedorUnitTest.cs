...
{
    [TestClass]
    public class MaquinariaPorProveedorUnitTest
    {
        private readonly InsumoService _insumoService;

        private readonly IMapper _mapper;
        private readonly Mock<MaquinariaPorProveedorRepository> _maquinariaPorProveedorRepositoryMock;
        public Mock<MaquinariaPorProveedorRepository> MockPlanillaRepositiry { get; private set; }

        public MaquinariaPorProveedorUnitTest()
        {
            _maquinariaPorProveedorRepositoryMock = new Mock<MaquinariaPorProveedorRepository>();
            if (_mapper == null)
            {
        ...
        {
            var data = new tbMaquinariasPorProveedores();
            var result = _insumoService.InsertarMaquinariaPorProveedor(data);
        ...
        {
            var data = new tbMaquinariasPorProveedores();
            var result = _insumoService.ActualizarMaquinariaPorProveedor(data);
