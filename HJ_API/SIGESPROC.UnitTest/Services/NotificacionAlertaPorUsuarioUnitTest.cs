...
{
    [TestClass]
    public class NotificacionAlertaPorUsuarioUnitTest
    {
        ...
        public NotificacionAlertaPorUsuarioUnitTest()
        {
        ...
        [TestMethod]
        public void NotificacionAlertaPorUsuarioCreate()
        {
            ...
            MockNotificacionAlertaPorUsuarioRepository.Setup(pr => pr.Insert(It.IsAny<tbNotificacionesAlertarPorUsuario>()))
              .Returns(new RequestStatus { CodeStatus = 1, MessageStatus = "Exito" });

            var result = _proyectoService.InsertarNotificacionPorUsuario(modelo);
